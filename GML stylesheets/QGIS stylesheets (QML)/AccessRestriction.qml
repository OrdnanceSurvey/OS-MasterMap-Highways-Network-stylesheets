...
<qgis version="2.18.14" simplifyAlgorithm="0" minimumScale="100" maximumScale="6000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="localId">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="beginLifespanVersion">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="restriction">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="reasonForChange">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="trafficSign">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="trafficSign" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="Buses and pedal cycles only" label="Buses and pedal cycles only"/>
      <category render="true" symbol="1" value="Buses and taxis only" label="Buses and taxis only"/>
      <category render="true" symbol="2" value="Buses only" label="Buses only"/>
      <category render="true" symbol="3" value="Buses, pedal cycles and taxis only" label="Buses, pedal cycles and taxis only"/>
      <category render="true" symbol="4" value="Buses, pedal cycles, motor cycles and taxis only" label="Buses, pedal cycles, motor cycles and taxis only"/>
      <category render="true" symbol="5" value="Local buses only" label="Local buses only"/>
      <category render="true" symbol="6" value="Local buses, school buses and taxis only" label="Local buses, school buses and taxis only"/>
      <category render="true" symbol="7" value="Motor cycles only" label="Motor cycles only"/>
      <category render="true" symbol="8" value="No abnormal loads" label="No abnormal loads"/>
      <category render="true" symbol="9" value="No articulated vehicles" label="No articulated vehicles"/>
      <category render="true" symbol="10" value="No buses" label="No buses"/>
      <category render="true" symbol="11" value="No cycling" label="No cycling"/>
      <category render="true" symbol="12" value="No Entry" label="No Entry"/>
      <category render="true" symbol="13" value="No goods vehicles over 17.5T" label="No goods vehicles over 17.5T"/>
      <category render="true" symbol="14" value="No goods vehicles over 17T" label="No goods vehicles over 17T"/>
      <category render="true" symbol="15" value="No goods vehicles over 18T" label="No goods vehicles over 18T"/>
      <category render="true" symbol="16" value="No goods vehicles over 3.5T" label="No goods vehicles over 3.5T"/>
      <category render="true" symbol="17" value="No goods vehicles over 33T" label="No goods vehicles over 33T"/>
      <category render="true" symbol="18" value="No goods vehicles over 3T" label="No goods vehicles over 3T"/>
      <category render="true" symbol="19" value="No goods vehicles over 5T" label="No goods vehicles over 5T"/>
      <category render="true" symbol="20" value="No goods vehicles over 7.5T" label="No goods vehicles over 7.5T"/>
      <category render="true" symbol="21" value="No heavy goods vehicles" label="No heavy goods vehicles"/>
      <category render="true" symbol="22" value="No motor vehicles" label="No motor vehicles"/>
      <category render="true" symbol="23" value="No motor vehicles except solo motor cycles" label="No motor vehicles except solo motor cycles"/>
      <category render="true" symbol="24" value="No solo motorcycles" label="No solo motorcycles"/>
      <category render="true" symbol="25" value="No towed caravans" label="No towed caravans"/>
      <category render="true" symbol="26" value="No vehicles" label="No vehicles"/>
      <category render="true" symbol="27" value="No wide loads" label="No wide loads"/>
      <category render="true" symbol="28" value="Non-statutory no vehicles" label="Non-statutory no vehicles"/>
      <category render="true" symbol="29" value="Pedal cycles, local buses and taxis only" label="Pedal cycles, local buses and taxis only"/>
      <category render="true" symbol="30" value="School buses only" label="School buses only"/>
      <category render="true" symbol="31" value="Taxis only" label="Taxis only"/>
      <category render="true" symbol="32" value="Unsuitable for coaches" label="Unsuitable for coaches"/>
      <category render="true" symbol="33" value="Unsuitable for heavy goods vehicles" label="Unsuitable for heavy goods vehicles"/>
      <category render="true" symbol="34" value="Unsuitable for large vehicles" label="Unsuitable for large vehicles"/>
      <category render="true" symbol="35" value="Unsuitable for long vehicles" label="Unsuitable for long vehicles"/>
      <category render="true" symbol="36" value="Unsuitable for motor vehicles" label="Unsuitable for motor vehicles"/>
      <category render="true" symbol="37" value="Unsuitable for towed caravans" label="Unsuitable for towed caravans"/>
      <category render="true" symbol="38" value="Unsuitable for wide vehicles" label="Unsuitable for wide vehicles"/>
      <category render="true" symbol="39" value="Unsuitable for buses" label="Unsuitable for buses"/>
      <category render="true" symbol="40" value="Non-statutory wide loads only" label="Non-statutory wide loads only"/>
      <category render="true" symbol="41" value="Pedal cycles only" label="Pedal cycles only"/>
      <category render="true" symbol="42" value="Pedal cycles and motor cycles only" label="Pedal cycles and motor cycles only"/>
      <category render="true" symbol="43" value="No light goods vehicles" label="No light goods vehicles"/>
      ...
      <category render="true" symbol="51" value="Local buses and school buses only" label="Local buses and school buses only"/>
      <category render="true" symbol="52" value="Tramcars only" label="Tramcars only"/>
      <category render="true" symbol="53" value="Unsuitable for through traffic" label="Unsuitable for through traffic"/>
  ...
  <aliases>
    ...
    <alias field="TOID" index="1" name=""/>
    <alias field="localId" index="2" name=""/>
    <alias field="beginLifespanVersion" index="3" name=""/>
    <alias field="restriction" index="4" name=""/>
    <alias field="reasonForChange" index="5" name=""/>
    <alias field="trafficSign" index="6" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;trafficSign&quot;" sortOrder="0">
    <columns>
      <column width="-1" hidden="0" type="field" name="OBJECTID"/>
      <column width="-1" hidden="0" type="field" name="TOID"/>
      <column width="-1" hidden="0" type="field" name="localId"/>
      <column width="-1" hidden="0" type="field" name="beginLifespanVersion"/>
      <column width="-1" hidden="0" type="field" name="restriction"/>
      <column width="-1" hidden="0" type="field" name="reasonForChange"/>
      <column width="331" hidden="0" type="field" name="trafficSign"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="TOID" expression=""/>
    <default field="localId" expression=""/>
    <default field="beginLifespanVersion" expression=""/>
    <default field="restriction" expression=""/>
    <default field="reasonForChange" expression=""/>
    <default field="trafficSign" expression=""/>
  </defaults>
