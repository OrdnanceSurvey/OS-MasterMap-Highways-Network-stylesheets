...
xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.0.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    <Name>OS MasterMap&#174; Highways Network &#8482; RestrictionForVehicles </Name>
    <UserStyle>
      ...
      <FeatureTypeStyle>
        <Rule>
        <Name>RestrictionForVehicles</Name>
        <MinScaleDenominator>250</MinScaleDenominator>
        <MaxScaleDenominator>6000</MaxScaleDenominator>
        <PointSymbolizer>
          <Graphic>
            <ExternalGraphic>
              <OnlineResource xlink:type="simple" xlink:href="ordnance_survey_highways/${restrictiontype}.svg" />
